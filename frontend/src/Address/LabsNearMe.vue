<template>
  <div>
    ...
    <div class="container flex flex-col md:flex-row justify-left items-left gap-4 mb-2">
      ...
      <div class="relative w-full max-w-sm shadow-md shadow-gray-300 rounded-full">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
          ...
          <path stroke-linecap="round" stroke-linejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 
          0 1 0 5.196 5.196a7.5 7.5 
          0 0 0 10.607 10.607Z" />
        </svg>
        <input v-model="pincodeQuery" type="text" placeholder="Search by Pincode..."
      ...
      <div class="relative w-full max-w-sm shadow-md shadow-gray-300 rounded-full">
        ...
        <input v-model="cityQuery" type="text" placeholder="Search by City..."
          class="w-full border border-gray-300 rounded-full py-2.5 pl-12 pr-4 text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#001D55]" />
      </div>
    </div>
    ...
    <div class="container flex justify-center items-center p-3">
      ...
      <!-- Cards Grid -->
      <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl w-full">
        <div v-for="(center, index) in filteredCenters" :key="index"
          ...
          <div v-if="center.is_website === 'Yes' && center.website" class="mb-3">
            <a :href="center.website.startsWith('http') ? center.website : 'https://' + center.website" target="_blank"
              class="text-[#001D55] underline flex items-center gap-2 text-sm font-semibold">
              <!-- Globe Icon -->
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="w-5 h-5 text-[#001D55]">
          ...
          <div class="flex flex-col sm:flex-row gap-3 mt-auto">
            ...
            <a v-if="center.is_phone === 'Yes' && center.phone_number" :href="'tel:' + center.phone_number"
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                ...
                <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6.75c0 8.284 6.716 15 
            ...
            <!-- Google Map -->
            <a v-if="center.map_embed_link" :href="center.map_embed_link" target="_blank"
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                ...
                <path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 1 1-6 0 
                3 3 0 0 1 6 0Z" />
                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 
